...
```
git clone https://github.com/Wils-FOURR-speed/Awesome-Books.git
```
...
Feel free to leave any suggestions at the [Issues page](https://github.com/Wils-FOURR-speed/Awesome-Books/issues)
